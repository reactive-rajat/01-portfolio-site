...
function Contact() {
  ...
  const pageContent = (
    ...
    >
      {/* ── Primary action: WhatsApp card or email form ── */}
      <motion.div variants={fadeInUp} className="space-y-6">
        {!showForm ? (
          <>
            <p className="text-white/50 leading-relaxed text-base max-w-xl">
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-500/60 font-medium">
          ...
          <div className="animate-in fade-in slide-in-from-top-3 duration-400 space-y-6">
            <p className="text-white/50 leading-relaxed text-base max-w-xl">
              {contact.whatsapp.description}
            </p>
            <form id="contact-form" onSubmit={handleSubmit} className="space-y-4 max-w-lg">
        ...
        <p className="text-white/30 text-sm">
          ...
          <button
            ...
            className="text-[hsl(var(--theme-base))] hover:underline font-medium"
          >
            {!showForm ? contact.prompts.switchToEmail : contact.prompts.switchToWhatsApp}
          </button>
        </p>
      </motion.div>

      {/* ── Info strip: email, phone, location + socials ── */}
      <motion.div
        variants={fadeInUp}
        className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-4 border-t border-white/5"
      >
        {/* Email */}
        {emailItem && (
          <a
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[10px] uppercase tracking-widest text-white/30 font-bold mb-0.5">Email</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2 px-1">
            <p className="text-[10px] uppercase tracking-widest text-white/20 font-bold mr-1">
            ...
            {global.socialLinks.map((item) => {
              ...
              return (
                <IconButton
                  ...
                  size="sm"
                  className="!w-9 !h-9 !rounded-lg hover:scale-110 hover:!border-[hsl(var(--theme-base)/0.4)] hover:!text-[hsl(var(--theme-base))]"
                />
              );
            })}
          </div>
